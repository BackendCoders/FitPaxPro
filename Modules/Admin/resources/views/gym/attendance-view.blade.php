...
@section('title', 'Attendance Details | FitPaxPro')
...
@section('content')
    ...
    <section class="page-hero">
        <article class="surface-card hero-card">
            ...
            <h1 class="hero-title">Attendance Details</h1>
        </article>
    </section>

    <section class="panel-card">
        <div class="action-row">
            <a class="btn-mini" href="{{ route('admin.gym.attendance') }}">Back to Attendance Logs</a>
        </div>
        ...
        <table class="detail-table">
            <tbody>
                @foreach ($attendanceColumns as $column)
                    @php
                        $value = data_get($attendance, $column);
                        $rendered = match (true) {
                            is_null($value) => 'N/A',
