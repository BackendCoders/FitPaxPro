...
@section('title', 'Gym Reviews | FitPaxPro')
...
@section('content')
    ...
    <section class="page-hero">
        <article class="surface-card hero-card">
            ...
            <h1 class="hero-title">Gym Reviews</h1>
        </article>
        ...
        <div class="side-stack">
            <article class="surface-card">
                ...
                <div class="insight-list">
                    ...
                    @if ($reviewSortColumn)
                        <div class="chat-item">
                            <strong>{{ str_replace('_', ' ', $reviewSortColumn) }}</strong>
                            <div class="muted">Sorted by (desc)</div>
                        </div>
                    @endif
                </div>
            </article>
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="action-row">
                                    <a class="btn-mini" href="{{ route('admin.gym.reviews.view', $review) }}">View</a>
                                </div>
                            </td>
                        </tr>
                    @empty
                        <tr>
                            <td colspan="{{ count($reviewColumns) + 1 }}" class="muted" style="text-align:center; padding: 22px;">No reviews found.</td>
                        </tr>
                    @endforelse
                </tbody>
            </table>
