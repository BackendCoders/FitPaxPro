<x-app-layout title="Edit Exercise | Admin Command Center">
    <style>
    ...
    <div class="form-wrapper">
        ...
        <div class="page-header mb-5">
            <h4>Edit Exercise Asset</h4>
            <p>Update image, coaching notes, and training metadata</p>
        </div>

        <form action="{{ route('admin.exercise-library.update', $exercise->id) }}" method="POST" enctype="multipart/form-data">
            @csrf
            @method('PUT')
            ...
            <div class="tactical-card">
                <div class="row g-4">
                    <div class="col-lg-5">
                        ...
                        <input type="file" name="image" class="form-control stealth-input" accept="image/*">
                    ...
                    <div class="col-lg-7">
                        <div class="row g-4">
                            <div class="col-md-8">
                                ...
                                <input type="text" name="exercise_name" class="form-control stealth-input" value="{{ old('exercise_name', $exercise->exercise_name) }}" required>
                            </div>
                            <div class="col-md-4">
                                <label class="field-label">Display Order</label>
                                <input type="number" name="order_index" class="form-control stealth-input" value="{{ old('order_index', $exercise->order_index) }}">
                            </div>
                            <div class="col-md-4">
                                <label class="field-label">Status</label>
                                <select name="is_active" class="form-control stealth-input">
                                    <option value="1" {{ old('is_active', $exercise->is_active) ? 'selected' : '' }}>Active</option>
                                    <option value="0" {{ old('is_active', $exercise->is_active) ? '' : 'selected' }}>Inactive</option>
                                </select>
                            </div>

                            <div class="col-md-4">
                                <label class="field-label">Muscle Group</label>
                                <input type="text" name="target_muscle_group" class="form-control stealth-input" value="{{ old('target_muscle_group', $exercise->target_muscle_group) }}">
                            </div>
                            <div class="col-md-4">
                                <label class="field-label">Category</label>
                                <input type="text" name="exercise_category" class="form-control stealth-input" value="{{ old('exercise_category', $exercise->exercise_category) }}">
                            </div>
                            <div class="col-md-4">
                                <label class="field-label">Difficulty</label>
                                <input type="text" name="difficulty_level" class="form-control stealth-input" value="{{ old('difficulty_level', $exercise->difficulty_level) }}">
                            </div>

                            <div class="col-md-4">
                                <label class="field-label">Equipment</label>
                                <input type="text" name="equipment_type" class="form-control stealth-input" value="{{ old('equipment_type', $exercise->equipment_type) }}">
                            </div>
                            <div class="col-md-4">
                            ...
                            <div class="col-md-4">
                                ...
                                <input type="text" name="reps" class="form-control stealth-input" value="{{ old('reps', $exercise->reps) }}">
                            </div>
                            ...
                            <div class="col-md-4">
                                ...
                                <input type="text" name="instruction_video_url" class="form-control stealth-input" value="{{ old('instruction_video_url', $exercise->instruction_video_url) }}">
                            </div>

                            <div class="col-12">
                                <label class="field-label">Instructions</label>
                                <textarea name="instructions" rows="4" class="form-control stealth-input">{{ old('instructions', $exercise->instructions) }}</textarea>
                            </div>

                            <div class="col-12">
                                <label class="field-label">Tips</label>
                                <textarea name="tips" rows="3" class="form-control stealth-input">{{ old('tips', $exercise->tips) }}</textarea>
                            </div>
                        </div>
                    </div>
                </div>
